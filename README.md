...
Перед началом работы нужно установить зависимоси, если они не уставновлены

Разработка: понимаем задачу, декомпозируем, пишем код, пишем тесты, добиваемся чтобы тесты проходили и код правильно выполнялся

В конце любой рабочей сессии: делаем коммит и пушим https://gist.github.com/qelphybox/50319b82806573c74cac8a151a39a32f
